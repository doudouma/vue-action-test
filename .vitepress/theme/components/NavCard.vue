...
<template>
  <div class="grid auto-rows-auto grid-cols-2 gap-[12px] backdrop-grayscal">
    <section v-for="navItem of navData" :key="navItem.id"> 
      ...
      >
        ...
        >
          <span
            class="text-gray-600 group-hover:text-gray-800 dark:text-gray-300 dark:group-hover:text-gray-100"
          >
            {{ navItem.text }}
          </span>
          <span
